...
import { Menu, X, ArrowRight, Compass, User, Award, MapPin } from 'lucide-react';
  ...
  return (
    <div className="relative w-full min-h-screen h-screen overflow-hidden bg-white text-[#11161B] flex flex-col justify-between select-none font-sans">
      ...
      <div 
        ...
        style={{
          background: 'radial-gradient(circle at 12% 22%, rgba(168, 204, 238, 0.75) 0%, rgba(200, 225, 248, 0.45) 35%, rgba(255, 255, 255, 0) 70%)'
        }}
      />
      ...
      <div 
        ...
        style={{
          background: 'radial-gradient(circle at 90% 32%, rgba(255, 178, 120, 0.7) 0%, rgba(255, 210, 175, 0.35) 40%, rgba(255, 255, 255, 0) 72%)'
        }}
      />
      ...
      <div 
        ...
        style={{
          background: 'radial-gradient(circle, rgba(255, 175, 115, 0.45) 0%, rgba(255, 185, 135, 0.25) 55%, rgba(255, 195, 150, 0.05) 70%, transparent 75%)',
          filter: 'blur(4px)'
        }}
      />
      ...
      <div className="absolute top-[44%] right-[11%] sm:right-[13%] pointer-events-none z-10 flex items-center space-x-3 opacity-70">
        {/* Bird 1 (Left) */}
        <svg className="w-4 h-3 transform -rotate-6" viewBox="0 0 24 14" fill="#6B4028">
          <path d="M 1 6 Q 6 1 12 5 Q 18 1 23 6 Q 18 7 12 6 Q 6 7 1 6 Z" />
        </svg>
        {/* Bird 2 (Middle - slightly larger and higher) */}
        <svg className="w-5 h-3.5 -mt-3 transform rotate-3" viewBox="0 0 24 14" fill="#6B4028">
          <path d="M 1 6 Q 6 1 12 5 Q 18 1 23 6 Q 18 7 12 6 Q 6 7 1 6 Z" />
        </svg>
        {/* Bird 3 (Right) */}
        <svg className="w-4 h-3 transform rotate-12" viewBox="0 0 24 14" fill="#6B4028">
          <path d="M 1 6 Q 6 1 12 5 Q 18 1 23 6 Q 18 7 12 6 Q 6 7 1 6 Z" />
        </svg>
      </div>
      ...
      */}
      ...
      <main className="relative z-20 flex-1 flex flex-col items-center justify-center text-center px-4 -mt-6 sm:-mt-8">
        ...
        {/* Navigation Row */}
        <nav aria-label="Hero Navigation" className="flex items-center space-x-7 sm:space-x-10 mb-5 sm:mb-6">
          <Link
            to="/home"
        ...
        <p className="text-[13.5px] sm:text-[15px] text-[#555E68] max-w-sm sm:max-w-md mx-auto leading-relaxed mb-5 sm:mb-6 font-normal">
          Your guide to India's rich cultural heritage —<br className="hidden sm:inline" />
          ...
          <div className="w-full max-w-sm bg-white h-full shadow-2xl p-6 flex flex-col justify-between animate-in slide-in-from-right duration-300">
            <div>
              <div className="flex items-center justify-between pb-6 border-b border-gray-100">
                <span className="text-2xl font-extrabold text-[#11161B]">nokku</span>
                <button
                  type="button"
